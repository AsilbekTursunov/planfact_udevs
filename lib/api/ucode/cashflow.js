...
export const getCashFlowReport = async (params = {}) => {
  ...
  const requestData = {
    ...
    ...(contrAgentId && contrAgentId.length > 0 && { contrAgentId }),
    ...(legalEntityId && legalEntityId.length > 0 && { legalEntityId }),
    ...(chartOfAccountsId && chartOfAccountsId.length > 0 && { chartOfAccountsId }),
    ...(includeTrendData !== undefined && { includeTrendData }),
    ...(isCalculation !== undefined && { isCalculation }),
    ...otherParams
  }
